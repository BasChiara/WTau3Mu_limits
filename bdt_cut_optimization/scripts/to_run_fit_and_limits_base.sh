...
WORK_DIR="##YOUR WOORKING DIR##"
TAG="###"
COMBINE_DIR="$BASE_DIR/bdt_cut_optimization/$WORK_DIR/input_combine"
EOS_DIR="/eos/user/c/cbasile/www/Tau3Mu_Run3/BDTtraining/cut_LxySign/#####/#####/"
YEAR=22
SIGNAL="/eos/user/c/cbasile/Tau3MuRun3/data/mva_data/XGBout_signal_######.root"
DATA="/eos/user/c/cbasile/Tau3MuRun3/data/mva_data/XGBout_data_#####.root"
