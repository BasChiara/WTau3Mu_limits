...
python3 $BASE_DIR/runBDTOptimCombine.py -i $COMBINE_DIR -o $EOS_DIR --scan_sensitivity input_combine/sensitivity_tree_bdt_scan_WTau3Mu_C22_HLT_overlap_LxyS1.5_2024May27.root -d WTau3Mu_C22_HLT_overlap_LxyS1.5_2024May27 -n WTau3Mu_C22_HLT_overlap_LxyS1.5_2024May27 --BDTmin 0.9900 --BDTmax 0.9995 --BDTstep 0.0005 -s all
# with HybridNew 
python3 $BASE_DIR/runBDTOptimCombine.py -i $COMBINE_DIR -o $EOS_DIR --scan_sensitivity input_combine/sensitivity_tree_bdt_scan_WTau3Mu_WTau3Mu_C22_HLT_overlap_LxyS1.5_2024May27.root -d WTau3Mu_C22_HLT_overlap_LxyS1.5_2024May27 -n WTau3Mu_C22_HLT_overlap_LxyS1.5_2024May27 -M HybridNew --BDTmin 0.9900 --BDTmax 0.9995 --BDTstep 0.0005 -s all
echo 'TIME TO COMPARE THE METHODS'
# compare the methods
python3 $BASE_DIR/compareLimitScan.py --inputs input_combine/Tau3MuCombine.WTau3Mu_C22_HLT_overlap_LxyS1.5_2024May27_BDTscan.AsymptoticLimits.root --labels AsymptoticLimits --inputs input_combine/Tau3MuCombine.WTau3Mu_C22_HLT_overlap_LxyS1.5_2024May27_BDTscan.HybridNew.root --labels HybridNew -o $EOS_DIR -d WTau3Mu_C22_HLT_overlap_LxyS1.5_2024May27 -n WTau3Mu_C22_HLT_overlap_LxyS1.5_2024May27 -y 20$YEAR -c $CATEGORY
