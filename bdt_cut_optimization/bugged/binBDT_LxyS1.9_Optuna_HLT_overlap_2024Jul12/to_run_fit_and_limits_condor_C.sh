...
python3 $BASE_DIR/runBDTOptimCombine.py -i $COMBINE_DIR -o $EOS_DIR --scan_sensitivity input_combine/sensitivity_tree_bdt_scan_WTau3Mu_C22_LxyS1.9_Optuna_HLT_overlap_2024Jul12.root -d WTau3Mu_C22_LxyS1.9_Optuna_HLT_overlap_2024Jul12 -n WTau3Mu_C22_LxyS1.9_Optuna_HLT_overlap_2024Jul12 --BDTmin 0.9900 --BDTmax 0.9995 --BDTstep 0.0005 -s all
# with HybridNew 
python3 $BASE_DIR/runBDTOptimCombine.py -i $COMBINE_DIR -o $EOS_DIR --scan_sensitivity input_combine/sensitivity_tree_bdt_scan_WTau3Mu_C22_LxyS1.9_Optuna_HLT_overlap_2024Jul12.root -d WTau3Mu_C22_LxyS1.9_Optuna_HLT_overlap_2024Jul12 -n WTau3Mu_C22_LxyS1.9_Optuna_HLT_overlap_2024Jul12 -M HybridNew --BDTmin 0.9900 --BDTmax 0.9995 --BDTstep 0.0005 -s all
echo 'TIME TO COMPARE THE METHODS'
# compare the methods
python3 $BASE_DIR/compareLimitScan.py --inputs input_combine/Tau3MuCombine.WTau3Mu_C22_LxyS1.9_Optuna_HLT_overlap_2024Jul12_BDTscan.AsymptoticLimits.root --labels AsymptoticLimits --inputs input_combine/Tau3MuCombine.WTau3Mu_C22_LxyS1.9_Optuna_HLT_overlap_2024Jul12_BDTscan.HybridNew.root --labels HybridNew -o $EOS_DIR -d WTau3Mu_C22_LxyS1.9_Optuna_HLT_overlap_2024Jul12 -n WTau3Mu_C22_LxyS1.9_Optuna_HLT_overlap_2024Jul12 -y 20$YEAR -c $CATEGORY
