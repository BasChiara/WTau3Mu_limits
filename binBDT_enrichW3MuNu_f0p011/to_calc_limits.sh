...
echo 'Fit catgeory A'
bdt_A=0.999
python3 ../Tau3Mu_fitSB.py --plot_outdir /eos/user/c/cbasile/www/Tau3Mu_Run3/limits/binBDT_enrichW3MuNu_f0p011_2024May01/ --save_ws --double_gaussian --category A -y 22 --bdt_cut ${bdt_A} --combine_dir input_combine/ --tag W3Mf0p011
...
echo 'Fit catgeory B'
bdt_B=0.998
python3 ../Tau3Mu_fitSB.py --plot_outdir /eos/user/c/cbasile/www/Tau3Mu_Run3/limits/binBDT_enrichW3MuNu_f0p011_2024May01/ --save_ws --double_gaussian --category B -y 22 --bdt_cut ${bdt_B} --combine_dir input_combine/ --tag W3Mf0p011
text2workspace.py input_combine/datacard_WTau3Mu_B22_bdt998_B22_W3Mf0p011.txt
echo '\n\n\n'
# 2022 C
echo 'Fit catgeory C'
bdt_C=0.997
python3 ../Tau3Mu_fitSB.py --plot_outdir /eos/user/c/cbasile/www/Tau3Mu_Run3/limits/binBDT_enrichW3MuNu_f0p011_2024May01/ --save_ws --double_gaussian --category C -y 22 --bdt_cut ${bdt_C} --combine_dir input_combine/ --tag W3Mf0p011
